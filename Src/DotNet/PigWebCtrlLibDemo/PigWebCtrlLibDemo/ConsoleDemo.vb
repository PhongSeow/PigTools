            ...
            Select Case Me.MenuKey
                ...
                Case "WebLogicDomain.GetDomainEnvInf"
                    ...
                    If Me.WebLogicDomain Is Nothing Then
                        Console.WriteLine("WebLogicDomain Is Nothing")
                    Else
                        Me.Ret = Me.WebLogicDomain.GetDomainEnvInf()
                        Console.WriteLine(Me.Ret)
                        If Me.Ret = "OK" Then
                            With Me.WebLogicDomain
                                Console.WriteLine("WL_HOME=" & .WL_HOME)
                                Console.WriteLine("SUN_JAVA_HOME=" & .SUN_JAVA_HOME)
                                Console.WriteLine("DEFAULT_SUN_JAVA_HOME=" & .DEFAULT_SUN_JAVA_HOME)
                                Console.WriteLine("WLS_MEM_ARGS_64BIT=" & .WLS_MEM_ARGS_64BIT)
                                Console.WriteLine("WLS_MEM_ARGS_32BIT=" & .WLS_MEM_ARGS_32BIT)
                            End With
                        End If
                    End If
                ...
                Case "ShowParas"
                    ...
                    For Each oWebLogicDomain As WebLogicDomain In Me.WebLogicApp.WebLogicDomains
                        ...
                        With oWebLogicDomain
                            ...
                            Console.WriteLine("WebLogicDeploys=" & .WebLogicDeploys.Count)
                            For Each oWebLogicDeploy As WebLogicDeploy In .WebLogicDeploys
                                Console.WriteLine("DeployName=" & oWebLogicDeploy.DeployName)
                                Console.WriteLine("ModuleType=" & oWebLogicDeploy.ModuleType.ToString)
                                Console.WriteLine("SourcePath=" & oWebLogicDeploy.SourcePath)
                            Next
                        End With
                        Console.WriteLine("*******************")
                    Next
