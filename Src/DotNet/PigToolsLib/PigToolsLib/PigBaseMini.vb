...
#End If
    ...
    ''' <summary>调试</summary>
    Friend Overloads Function PrintDebugLog(LogInf As String, IsHardDebug As Boolean) As String
        PrintDebugLog = Me.mPrintDebugLog("", LogInf, IsHardDebug)
    End Function

    ''' <summary>调试</summary>
    Friend Overloads Function PrintDebugLog(StepName As String, LogInf As String, IsHardDebug As Boolean) As String
        PrintDebugLog = Me.mPrintDebugLog(StepName, LogInf, IsHardDebug)
    End Function

    ''' <summary>调试</summary>
    Friend Overloads Function PrintDebugLog(StepName As String, LogInf As String) As String
        PrintDebugLog = Me.mPrintDebugLog(StepName, LogInf, False)
    End Function

    ''' <summary>调试</summary>
    Friend Overloads Function PrintDebugLog(LogInf As String) As String
